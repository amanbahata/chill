...
public class TrendingFragmentTest {
    ...
    @Rule
    public FragmentTestRule<TrendingFragment> mFragmentTestRule =
            new FragmentTestRule<>(TrendingFragment.class);
    ...
    public void fragmentCanBeInstantiated() throws InterruptedException {
        onView(withId(R.id.fl_trending)).check(matches(isDisplayed()));
    ...
    public void testRecyclerViewScrolling() throws InterruptedException {
        Thread.sleep(1500);
        onView(withId(R.id.article_recyclerview)).perform(RecyclerViewActions.scrollToPosition(4),
    ...
    public void testRecyclerViewThenPerformClick() throws InterruptedException {
        Thread.sleep(1500);
        onView(withId(R.id.article_recyclerview)).perform(
